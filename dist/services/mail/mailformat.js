...
exports.EmailVerifyMail = exports.ResetPasswordMail = exports.RegisterSuccussMail = exports.VerificationMail = void 0;
const VerificationMail = (userName, verificationCode) => {
    return `
  <!DOCTYPE html>
  <html lang="en">
  <head>
...
const RegisterSuccussMail = (appName, userName) => {
    return `
  <html lang="en">
<head>
  <meta charset="UTF-8">
...
exports.RegisterSuccussMail = RegisterSuccussMail;
const ResetPasswordMail = (appName, userName, otp) => {
    return `<!DOCTYPE html>
  <html lang="en">
  <head>
      <meta charset="UTF-8">
...
const EmailVerifyMail = (appName, otp) => {
    return `
...
exports.EmailVerifyMail = EmailVerifyMail;
